...
default_font = resource_filename('patternizer.resources.default_fonts', 'LobsterTwo-Bold.ttf')

def patternize(text=None, pattern="@", fontpath=default_font, fontsize=15):
    if text is None:
